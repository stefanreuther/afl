...
TestChecksumsSHA256::testBasic()
{
    ...
    // Check string
    TS_ASSERT_EQUALS(cc.getHashAsHexString(), "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855");
    ...
    TS_ASSERT_EQUALS(result.size(), 32U);
    TS_ASSERT_SAME_DATA(bytes, large, 32);

    // Self-information
    TS_ASSERT_EQUALS(cc.getHashSize(), 32U);
    TS_ASSERT_EQUALS(cc.getHashSize(), cc.HASH_SIZE);
    TS_ASSERT_EQUALS(cc.getBlockSize(), 64U);
}

/** Hash tests from RFC 6234. */
void
TestChecksumsSHA256::test6234()
{
...
void
TestChecksumsSHA256::test6234HMAC()
{
    afl::checksums::SHA256 cc;
    ...
    TS_ASSERT_EQUALS(cc.getHashAsHexString(), "b0344c61d8db38535ca8afceaf0bf12b881dc200c9833da726e9376c2e32cff7");
    ...
    TS_ASSERT_EQUALS(cc.getHashAsHexString(), "5bdcc146bf60754e6a042426089575c75a003f089d2739839dec58b964ec3843");
    ...
    cc.computeHMAC(afl::string::toBytes("\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa"
                   ...
                   afl::string::toBytes("\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd"
                                        ...
                                        "\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd"
                                        "\xdd\xdd\xdd\xdd\xdd"));
    TS_ASSERT_EQUALS(cc.getHashAsHexString(), "773ea91e36800e46854db8ebd09181a72959098b3ef8c122d9635514ced565fe");
    ...
    cc.computeHMAC(afl::string::toBytes("\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f"
                   ...
                   afl::string::toBytes("\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd"
                                        ...
                                        "\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd"
                                        "\xcd\xcd\xcd\xcd\xcd"));
    TS_ASSERT_EQUALS(cc.getHashAsHexString(), "82558a389a443c0ea4cc819899f2083a85f0faa3e578f8077a2e3ff46729665b");
}
