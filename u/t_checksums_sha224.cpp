...
TestChecksumsSHA224::testBasic()
{
    ...
    // Check string
    TS_ASSERT_EQUALS(cc.getHashAsHexString(), "d14a028c2a3a2bc9476102bb288234c415a2b01f828ea62ac5b3e42f");
    ...
    TS_ASSERT_EQUALS(result.size(), 28U);
    TS_ASSERT_SAME_DATA(bytes, large, 28);

    // Self-information
    TS_ASSERT_EQUALS(cc.getHashSize(), 28U);
...
void
TestChecksumsSHA224::test6234HMAC()
{
    afl::checksums::SHA224 cc;
    ...
    TS_ASSERT_EQUALS(cc.getHashAsHexString(), "896fb1128abbdf196832107cd49df33f47b4b1169912ba4f53684b22");
    ...
    TS_ASSERT_EQUALS(cc.getHashAsHexString(), "a30e01098bc6dbbf45690f3a7e9e6d0f8bbea2a39e6148008fd05e44");
    ...
    cc.computeHMAC(afl::string::toBytes("\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa"
                   ...
                   afl::string::toBytes("\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd"
                                        ...
                                        "\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd\xdd"
                                        "\xdd\xdd\xdd\xdd\xdd"));
    TS_ASSERT_EQUALS(cc.getHashAsHexString(), "7fb3cb3588c6c1f6ffa9694d7d6ad2649365b0c1f65d69d1ec8333ea");
    ...
    cc.computeHMAC(afl::string::toBytes("\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f"
                   ...
                   afl::string::toBytes("\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd"
                                        ...
                                        "\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd\xcd"
                                        "\xcd\xcd\xcd\xcd\xcd"));
    TS_ASSERT_EQUALS(cc.getHashAsHexString(), "6c11506874013cac6a2abc1bb382627cec6a90d86efc012de7afec5a");
}
