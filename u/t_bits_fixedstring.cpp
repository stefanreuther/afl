...
TestBitsFixedString::testUnpack()
{
    using afl::base::ConstBytes_t;
    {
        ...
        TS_ASSERT_EQUALS(afl::string::fromBytes(afl::bits::unpackFixedString(ConstBytes_t(a))), "abc");
    }
    {
        static const uint8_t a[] = { 'a', 'b', 'c', 'd', 'e' };
        TS_ASSERT_EQUALS(afl::string::fromBytes(afl::bits::unpackFixedString(ConstBytes_t(a))), "abcde");
    }
    {
        static const uint8_t a[] = { 'a', 'b', '\0', 'd', 'e' };
        TS_ASSERT_EQUALS(afl::string::fromBytes(afl::bits::unpackFixedString(ConstBytes_t(a))), "ab");
    }
    {
        static const uint8_t a[] = { ' ', ' ', ' ', ' ', ' ' };
        TS_ASSERT_EQUALS(afl::string::fromBytes(afl::bits::unpackFixedString(ConstBytes_t(a))), "");
    }
    {
...
TestBitsFixedString::testPack()
{
    ...
    afl::bits::packFixedString(Bytes_t(tmp), afl::string::toBytes(""));
    TS_ASSERT_SAME_DATA(tmp, "     ", 5);

    afl::bits::packFixedString(Bytes_t(tmp), afl::string::toBytes("abc"));
    TS_ASSERT_SAME_DATA(tmp, "abc  ", 5);

    afl::bits::packFixedString(Bytes_t(tmp), afl::string::toBytes("abcde"));
    TS_ASSERT_SAME_DATA(tmp, "abcde", 5);

    afl::bits::packFixedString(Bytes_t(tmp), afl::string::toBytes("yxcvbnm"));
...
TestBitsFixedString::testClass()
{
    ...
    TS_ASSERT_EQUALS(afl::string::fromBytes(FS_t::unpack(a)), "lfm");

    uint8_t b[3];
    FS_t::pack(b, afl::string::toBytes("lfm"));
