/**
  *  \file u/t_net_http_cookiejar.cpp
...
TestNetHttpCookieJar::testIt()
{
    ...
    {
        afl::net::Url url;
        TS_ASSERT(url.parse("http://example.com/contact.html"));

        Consumer c;
        jar.enumerateCookies(url, c);
        TS_ASSERT_EQUALS(c.m_buffer, "language==en||color==red");
    }
    {
        afl::net::Url url;
        TS_ASSERT(url.parse("http://example.com/admin/edit"));
    ...
    {
        afl::net::Url url;
        TS_ASSERT(url.parse("https://example.com/admin/edit"));
    ...
    {
        afl::net::Url url;
        TS_ASSERT(url.parse("https://www.example.com/admin/edit"));

        Consumer c;
        jar.enumerateCookies(url, c);
        TS_ASSERT_EQUALS(c.m_buffer, "session==12345||language==en||color==red");
    }
    {
        afl::net::Url url;
        TS_ASSERT(url.parse("https://www.example.com/help/basics/"));

        Consumer c;
        jar.enumerateCookies(url, c);
        TS_ASSERT_EQUALS(c.m_buffer, "size==big||language==en||color==red");
    }

    // Modify it
    {
        afl::net::Url url;
        TS_ASSERT(url.parse("https://www.example.com/admin/logout"));
