...
namespace afl { namespace net {
    ...
    class NetworkStack : public afl::base::Deletable {
     public:
        ...
        virtual afl::base::Ptr<Listener> listen(const Name& name, int backlogSize) = 0;
        ...
        virtual afl::base::Ptr<Socket> connect(const Name& name, afl::sys::Timeout_t timeout = afl::sys::INFINITE_TIMEOUT) = 0;
